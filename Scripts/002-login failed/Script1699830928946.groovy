...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/input_Username_username'), 'worngusername')
...
WebUI.verifyElementVisible(findTestObject('Page_CURA Healthcare Service/p_Login failed Please ensure the username a_eb55b5'))

WebUI.takeScreenshot('screenshot/ss1.jpg')
